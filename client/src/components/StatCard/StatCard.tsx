...
function StatCard({ icon, value, label, className }: StatCardProps) {
    return (
        <div className={` bg-white p-6 rounded-lg text-center shadow-md border border-gray-200 transition-all duration-300 ease-in-out flex flex-col items-center gap-2 flex-1 ${className}`}>
